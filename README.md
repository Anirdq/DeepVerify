...
└─────────────────┘
🛠️ Tech Stack
| Layer | Technology | Purpose | |-------|-----------|---------| | Frontend | React 18 + Vite + TailwindCSS | User interface | | Backend | Python 3.11 + FastAPI | API server | | Detection | Ghostbuster + GLTR | AI text analysis | | AI Explain | Ollama + Mistral 7B | Plain-English explanations | | Database | PostgreSQL | Result persistence | | Deploy | Vercel + Render | Cloud hosting (free tier) |
...
Commit:
git add README.md git commit -m "Add comprehensive project documentation" git push origin main
